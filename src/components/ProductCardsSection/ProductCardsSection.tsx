...
const ProductCardsSection = ({ heading, counter, sectionClassName }: IPropsCardsSection): ReactElement => (
  <section className="_container cards-section">
    <div className="cards-section__header-container">
      ...
      <Link className="text-button" to="/catalog" onClick={(): void => window.scrollTo({ top: 0, behavior: 'smooth' })}>
        ⟶ Смотреть все
      </Link>
    </div>
