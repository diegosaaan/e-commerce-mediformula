...
const Card = React.forwardRef<HTMLDivElement, IPropsCard>(
  ({ imagePath, rating, text, price, priceBefore, bonus, discount, onClick }, ref): ReactElement => {
    const [isSelected, setIsSelected] = useState(false);

    return (
      <div ref={ref} className="product-card" onClick={onClick}>
